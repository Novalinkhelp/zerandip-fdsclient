...
import { bankBranchMasterConfig } from "../../config/formFieldsConfig";
...
const BankBranchMaster = () => {
    ...
    const handleSubmit = (formData) => {
        ...
        if (modalState.mode === "create") {
            ...
            setBranches(branches.map((b) => b.id === modalState.data.id ? { ...b, ...formData } : b));
        }
    }
    ...
    const columns = [
        ...
        },
        {
            key: "bank",
            header: "Bank",
            render: (item) => <span className="text-gray-600">{item.bank}</span>,
        },
        {
            key: "city",
            header: "City",
    ...
    return (
        <div onClick={closeAllDropdowns}>
            ...
            <Modal
                title={bankBranchMasterConfig.title}
                isOpen={modalState.isOpen}
                onClose={() => setModalState({ ...modalState, isOpen: false })}
                mode={modalState.mode}
                initialData={modalState.data}
                tabs={bankBranchMasterConfig.tabs}
