...
import { fetchOrderReportData } from "../../../utils/mockApi";
...
const OrderReports = () => {
    ...
    const config = getFormConfig("orderReport");
    ...
    useEffect(() => {
        const fetchReportData = async () => {
            ...
            try {
                const response = await fetchOrderReportData(reportType);
    ...
    const reportTypeSelection = {
        ...
        options: [
            {
                "value": "recommendedOrderReport",
                "label": "Recommended Order Report"
            },
            {
                "value": "finalOrderReport",
                "label": "Final Order Report"
            },
            {
                "value": "localPurchasesReport",
                "label": "Local Purchases Report"
            },
            {
                "value": "pendingOrderSummary",
                "label": "Pending Order Summary"
            },
            {
                "value": "backOrderItemsReport",
                "label": "Back Order Items Report"
            },
            {
                "value": "supplierInvoiceReport",
                "label": "Supplier Invoice Report"
            },
            {
                "value": "shipmentBinReport",
                "label": "Shipment Bin Report"
            },
            {
                "value": "shipmentPriceReport",
                "label": "Shipment Price Report"
            },
            {
                "value": "shipmentComparison",
                "label": "Shipment Comparison"
            },
            {
                "value": "importCostingReport",
                "label": "Import Costing Report"
            },
            {
                "value": "openOrderStockReport",
                "label": "Open Order Stock Report"
            },
            {
                "value": "additionalOrderStock",
                "label": "Additional Order Stock"
            },
            {
                "value": "unclearedQtyReport",
                "label": "Uncleared Qty Report"
            },
            {
                "value": "detailedShipmentReport",
                "label": "Detailed Shipment Report"
            },
            {
                "value": "recommendedUsManualRep",
                "label": "Recommended Us Manual Rep"
            },
            {
                "value": "expectedArrivalDateRep",
                "label": "Expected Arrival Date Rep"
            },
            {
                "value": "orderSheetReport",
                "label": "Order Sheet Report"
            },
            {
                "value": "foreignPurchaseReport",
                "label": "Foreign Purchase Report"
            }
        ],
