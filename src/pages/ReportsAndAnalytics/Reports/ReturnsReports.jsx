...
import { fetchReturnsReportData } from "../../../utils/mockApi";
...
const ReturnsReports = () => {
    ...
    const config = getFormConfig("returnsReport");
    ...
    useEffect(() => {
        const fetchReportData = async () => {
            ...
            try {
                const response = await fetchReturnsReportData(reportType);
    ...
    const reportTypeSelection = {
        ...
        options: [
            {
                "value": "returnsReportForMultipleItems",
                "label": "Returns Report - (for multiple items)"
            },
            {
                "value": "returnReportForSingleItem",
                "label": "Return Report - (for a single item)"
            }
        ],
