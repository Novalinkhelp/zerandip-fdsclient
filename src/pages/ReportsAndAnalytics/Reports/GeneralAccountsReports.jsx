...
import { fetchGeneralAccountsReportData } from "../../../utils/mockApi";
import FormField from "../../../components/forms/FormField"
import DynamicForm from "../../../components/forms/DynamicForm";
import Table from "../../../components/table/Table";
import { Printer } from "lucide-react";

const GeneralAccountsReports = () => {
    ...
    const config = getFormConfig("generalAccountsReport");
    ...
    useEffect(() => {
        const fetchReportData = async () => {
            ...
            try {
                const response = await fetchGeneralAccountsReportData(reportType);
    ...
    const reportTypeSelection = {
        ...
        options: [
            ...
            {
                "value": "statementByAccount",
                "label": "Statement by Account"
            },
            {
            ...
            {
                "value": "vatDetailAccListing",
                "label": "VAT Detail Account Listing"
            },
            {
                "value": "statementByAccountS",
                "label": "Statement by Account's"
            },
            {
                "value": "creditNotePriceDiff",
                "label": "Credit Note Price Dif."
            },
            {
                "value": "debitNotePriceDiff",
                "label": "Debit Note Price Dif."
            },
            {
                "value": "vatAccountsListing",
                "label": "VAT Accounts Listing."
            },
            {
                "value": "statForAccountRange",
                "label": "Stat. for Account Range"
            }
        ],
...
export default GeneralAccountsReports