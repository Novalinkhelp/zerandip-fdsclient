...
import { fetchSalesmanReportData } from "../../../utils/mockApi";
...
const SalesmanReports = () => {
    ...
    const config = getFormConfig("salesmanReport");
    ...
    useEffect(() => {
        const fetchReportData = async () => {
            ...
            try {
                const response = await fetchSalesmanReportData(reportType);
    ...
    const reportTypeSelection = {
        ...
        options: [
            {
                "value": "salesmanAgeAnalysisReport",
                "label": "Salesman Age Analysis Report"
            },
            {
                "value": "salesmanItemWiseReport",
                "label": "Salesman - Item Wise Report"
            },
            {
                "value": "salesmanStatementReport",
                "label": "Salesman - Statement Report"
            },
            {
                "value": "salesmanSettlementReport",
                "label": "Salesman - Settlement Report"
            }
        ],
