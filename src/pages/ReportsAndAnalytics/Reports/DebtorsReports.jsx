...
import { fetchDebtorsReportData } from "../../../utils/mockApi";

const DebtorsReports = () => {
    ...
    const config = getFormConfig("debtorsReport");
    ...
    useEffect(() => {
        const fetchReportData = async () => {
            ...
            try {
                const response = await fetchDebtorsReportData(reportType);
                if (response.success) {
    ...
    const reportTypeSelection = {
        ...
        options: [
            {
                "value": "debtorsAgeAnalysisRpt",
                "label": "Debtors Age Analysis Rpt"
            },
            {
                "value": "debtorsStatementInd",
                "label": "Debtors Statement <Ind>"
            },
            {
                "value": "debtorsStatementAll",
                "label": "Debtors Statement <All>"
            },
            {
                "value": "debtorsCollectionRpt",
                "label": "Debtors Collection Rpt"
            },
            {
                "value": "debtorsPaymentDaysRpt",
                "label": "Debtors Payment Days Rpt"
            },
            {
                "value": "debtorsStatementsFi",
                "label": "Debtors Statements FI"
            },
            {
                "value": "postDatedCheques",
                "label": "Post Dated Cheques"
            },
            {
                "value": "returnChequesReport",
                "label": "Return Cheques Report"
            },
            {
                "value": "targetAchievedCustomer",
                "label": "Target Achieved Customer"
            },
            {
                "value": "pendingInvoiceReport",
                "label": "Pending Invoice Report"
            },
            {
                "value": "debtorsAgeAnalysisHis",
                "label": "Debtors Age Analysis His"
            }
        ],
