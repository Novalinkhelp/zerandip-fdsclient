...
import { fetchOtherReportData } from "../../../utils/mockApi";
...
const OtherReports = () => {
    ...
    const config = getFormConfig("otherReports");
    ...
    useEffect(() => {
        const fetchReportData = async () => {
            ...
            try {
                const response = await fetchOtherReportData(reportType);
    ...
    const reportTypeSelection = {
        ...
        options: [
            {
                "value": "sellingPriceModifier",
                "label": "Selling Price Modifier"
            },
            {
                "value": "logReports",
                "label": "Log Reports"
            ...
            {
                "value": "salesRepVisitPlan",
                "label": "Sales Rep. Visit Plan"
            },
            {
                "value": "itemPriceChange",
                "label": "Item Price Change"
            }
        ],
