...
import { fetchStockReportData } from "../../../utils/mockApi";
...
const StockReports = () => {
    ...
    useEffect(() => {
        const fetchReportData = async () => {
            ...
            try {
                const response = await fetchStockReportData(reportType);
    ...
    const reportTypeSelection = {
        ...
        options: [
            {
                "value": "nh1StockReport",
                "label": "NH1 Stock Report"
            },
            {
            ...
            {
                "value": "deadStk3Month",
                "label": "Dead Stk - 3 Month"
            },
            {
                "value": "deadStk1Year",
                "label": "Dead Stk - 1 Year"
            },
            {
                "value": "stockOutReport",
            ...
            {
                "value": "itemPriceListing",
                "label": "Item Price Listing"
            },
            {
                "value": "forecastOrderListing",
                "label": "Forecast Order Listing"
            },
            {
                "value": "locationCompareRep",
                "label": "Location Compare Rep."
            },
            {
                "value": "verifyBalanceReport",
                "label": "Verify Balance Report"
            },
            {
                "value": "issueReturnReport",
                "label": "Issue/Return Report"
            },
            {
                "value": "pendingSkReport",
                "label": "Pending SK Report"
            },
            {
                "value": "stockMovementReport",
                "label": "Stock Movement Report"
            },
            {
                "value": "stockStatusReport",
                "label": "Stock Status Report"
            },
            {
                "value": "minimumQtyReport",
                "label": "Minimum Qty. Report"
            },
            {
                "value": "stockLocationReport",
                "label": "Stock Location Report"
            },
            {
                "value": "itemBreakDownLwRep",
                "label": "Item Break Down L/W Rep."
            },
            {
                "value": "itemBreakLwRepOld",
                "label": "Item Break L/W Rep. OLD"
            },
            {
                "value": "itemBreakDownOld",
                "label": "Item Break Down OLD"
            }
        ],
