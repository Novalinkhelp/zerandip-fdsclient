...
const CustomerAccountsJournals = () => {
    ...
    <div className="space-y-6">
      <div className="flex flex-col mb-4">
        <h1 className="text-2xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1 sm:mb-1.5">
          Customer Accounts - Data Entry Of Journals
        </h1>
        <p className="text-gray-600 text-base sm:text-lg">
          Handle data entry for journals in customer accounts.
        </p>
      </div>
...
export default CustomerAccountsJournals;
